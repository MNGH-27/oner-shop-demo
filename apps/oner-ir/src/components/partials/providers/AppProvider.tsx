...
export function AppProvider({ children }: { children: ReactNode }) {
  ...
  return <QueryClientProvider client={client}><CartSynchronizer/>{children}<ToastContainer position="bottom-left" rtl theme="light"/><ReactQueryDevtools initialIsOpen={false}/></QueryClientProvider>;
}
